...
var menuItems: [MenuItem] = [
    MenuItem.initMenuItem(title: "Home", imgName: "ico_home"),
//    MenuItem.initMenuItem(title: "Social", imgName: "ico_social"),
    MenuItem.initMenuItem(title: "Rate", imgName: "ico_rate"),
    MenuItem.initMenuItem(title: "About PartyFM", imgName: "ico_about")
]

var aboutItems: [AboutItem] = [
    AboutItem.initAboutItem(title: "Application Name", desc: "ParytyFM", imgName: "ico_about_name"),
...
//    AboutItem.initAboutItem(title: "Share", desc: "Share to your friends", imgName: "ico_about_share"),
    AboutItem.initAboutItem(title: "Rate", desc: "Bedøm denne app", imgName: "ico_about_rate"),
